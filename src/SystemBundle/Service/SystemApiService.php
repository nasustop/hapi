...
use SystemBundle\Repository\SystemApiRepository;
...
{
    protected SystemApiRepository $repository;
     ...
     * get Repository.
     */
    public function getRepository(): SystemApiRepository
    {
        if (empty($this->repository)) {
            $this->repository = make(SystemApiRepository::class);
        }
