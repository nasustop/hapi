...
{
    protected GoodsSpecValueRepository $repository;
     ...
     * get Repository.
     */
    public function getRepository(): GoodsSpecValueRepository
    {
        if (empty($this->repository)) {
            $this->repository = make(GoodsSpecValueRepository::class);
        }
